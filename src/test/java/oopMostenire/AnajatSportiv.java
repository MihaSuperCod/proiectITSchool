...
public class AnajatSportiv extends Persoana implements AngajatInterface,SportivInterface {
    ...
    public AnajatSportiv(String nume, String prenume, int varsta, String adresa, String firma, double salariu, String contract, int zileLibere, String sport, boolean sportEchipa, int experienta) {
